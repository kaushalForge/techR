              ...
              <div className="py-4 border-t-2 w-full">
                ...
                <div className="flex flex-col space-y-2">
                  {[
                    ...
                    { label: "Size", value: targetphone.size[0] },
                    ...
                    { label: "OS", value: targetphone.os[0] },
                    {
                      label: "Processor",
                      value:
                    ...
                    { label: "Capacity", value: targetphone.capacity[0] },
                    { label: "Charging", value: targetphone.charging[0] },
