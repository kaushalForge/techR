              ...
              <div className="py-4 border-t-2 w-full">
                ...
                <div className="flex flex-col space-y-2">
                  {[
                    ...
                    { label: "Size", value: targetlaptops.size[0] },
                    ...
                    { label: "OS", value: targetlaptops.os[0] },
                    {
                      label: "Processor",
                      value:
                    ...
                    { label: "Capacity", value: targetlaptops.capacity[0] },
                    { label: "Charging", value: targetlaptops.charging[0] },
