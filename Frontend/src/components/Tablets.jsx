...
const TABLET_SECTIONS = [
  { key: "gaming", title: "Gaming Tablets", borderColor: "border-indigo-600" },
  {
    key: "professional",
  ...
  {
    key: "students",
    title: "Student Tablets",
    borderColor: "border-orange-600",
  },
  {
    key: "normalusage",
    title: "Normal Usage Tablets",
    borderColor: "border-sky-600",
  },
];

function Tablets() {
  const queries = TABLET_SECTIONS.map(({ key }) => ({
    key,
  ...
  return (
    <HelmetProvider>
      <div className="min-h-screen flex flex-col justify-between">
        <Helmet>
          <title>
            Best Tablets of 2024 — Gaming, Professional, Students & More
          </title>
        </Helmet>
        {isLoading ? (
          <motion.div
          ...
          <div className="min-h-screen h-auto w-full mt-12">
            <div className="container mx-auto px-4 flex flex-col gap-6 md:gap-8 mb-12">
              ...
              {TABLET_SECTIONS.map(({ key, title, borderColor }) => {
