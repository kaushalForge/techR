...
const News = () => {
  const news = newsItems.join(" | ");
  return (
    <div className="w-full fixed mt-[88px] py-2 bg-[#000] overflow-hidden">
      <motion.div
        className="flex whitespace-nowrap text-[16px] text-gray-400 tracking-wide font-semibold"
      ...
      >
        <span className="pr-10">{news} | </span>
        <span className="pr-10">{news} | </span>
      </motion.div>
    </div>
  );
